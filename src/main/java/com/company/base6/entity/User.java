...
public class User implements JmixUserDetails, HasTimeZone {
    ...
    @Column(name = "STATUS_EXE_REF")
    private Integer statusExeRef;
    ...
    public StatusExecute getStatusExeRef() {
        return statusExeRef == null ? null : StatusExecute.fromId(statusExeRef);
    }

    public void setStatusExeRef(StatusExecute statusExeRef) {
        this.statusExeRef = statusExeRef == null ? null : statusExeRef.getId();
    }
