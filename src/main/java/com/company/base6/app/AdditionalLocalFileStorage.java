...
public class AdditionalLocalFileStorage implements FileStorage {
    ...
    public AdditionalLocalFileStorage() {
        this(DEFAULT_STORAGE_NAME);
    }

    public AdditionalLocalFileStorage(String storageName) {
     ...
     */
    public AdditionalLocalFileStorage(String storageName, String storageDir) {
        this(storageName);
